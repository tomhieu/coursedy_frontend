...
class LessonDetailFormContainer extends Component {
    ...
    render() {
        ...
        return (
            <form onSubmit={handleSubmit(this.props.onSubmit)} className='inline-form' key={lesson.id} multiple={true}>
                <div key={lesson.id} className="lesson-section-seperator">
                    <div className="row">
                        <div className="col-sm-8 col-md-8">
                            <InlineEditFormField activated={this.props.activatedField === "lessonNameId" + sectionUniqueKey} formGroupId={"lessonNameId" + sectionUniqueKey} formLabel={this.context.t("lesson_name")}
                        ...
                        <div className="col-sm-4 col-md-4">
                            <InlineEditFormField activated={this.props.activatedField === "lessonPeriodId"  + sectionUniqueKey} formGroupId={"lessonPeriodId" + sectionUniqueKey} formLabel={this.context.t("lesson_period")}
                    ...
                    <div className="row">
                        <div className="col-sm-4 col-md-4">
                            <div className="d-flex flex-vertical">
                                <InlineEditFormField activated={this.props.activatedField === "lessonDescId" + sectionUniqueKey} formGroupId={"lessonDescId" + sectionUniqueKey} showLabel={false} formLabel={this.context.t("lesson_desc")}
                        ...
                        <div className="col-sm-8 col-md-8">
                            <div>
                                <FormField formGroupId="lessonDocumentId" showLabel={false} formLabel={this.context.t("lesson_material")} onUpload={this.addDocumentForLesson.bind(this)}
