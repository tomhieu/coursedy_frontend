        ...
        return (
            <div className="row dashboard-panel">
                <div className="col-sm-12 col-md-12">
                    <CourseDetailContainer onActivatedField={this.onActivatedField.bind(this)}
                                           onClosedField={this.onClosedField.bind(this)} {...this.props}></CourseDetailContainer>
                </div>
                {
                    editMode ? (
                        <div className="col-sm-12 col-md-12">
                                ...
                                <div className="col-sm-12 col-md-12">
                                    {
                                        listSection.map((section) =>
                                            <SectionLessonContainer section={section} key={section.id}
                                                                    ...
                                                                    onClosedField={this.onClosedField.bind(this)} {...this.props}>
