...
class SectionLessonContainer extends Component {
  ...
  render() {
    ...
    return (
      <LoadingMask
        placeholderId={`sectionLessonPlaceholder${section.id}`}
        ...
        <div className="d-flex flex-auto lesson-container">
          <div className="card flex-auto">
              ...
              <div className="d-flex flex-horizontal">
                <div className="d-flex flex-auto">
                  <SectionDetailContainer
                    onSubmit={this.saveSection.bind(this)}
                    section={section}
                    {...this.props}
            ...
            <div className="card-actions">
              <PrimaryButton
                type="button"
                title={this.context.t('add_more_lesson')}
                callback={() => this.addLesson(section.id)}
                line={false}
              ...
              <PrimaryButton
                type="button"
                title={this.context.t('delete_lesson')}
                isPrimary={false}
                customClasses="align-btn"
                callback={() => this.props.openConfirmationPopup(
                  this.context.t('warning_delete_section_title'),
                  this.context.t('warning_delete_section_message', { sectionName: <strong>{section.title}</strong>, seperator: <br /> }),
                  this.deleteSection.bind(this, section.id)
                )}
              >
