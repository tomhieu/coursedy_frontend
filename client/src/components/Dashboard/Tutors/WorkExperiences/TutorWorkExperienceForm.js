  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit(onSubmit)}>
        <FormField formControlName="title" typeField='custom_input' fieldLabel={this.context.t('account.tutot.work.form.title')}/>
        <FormField formControlName="company" typeField='custom_input' fieldLabel={this.context.t('account.tutot.work.form.company')}/>
        <div className='row'>
