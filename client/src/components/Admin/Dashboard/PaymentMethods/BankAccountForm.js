      ...
      <form onSubmit={handleSubmit(this.props.onSubmit)}>
        <div className="bank-account">
          ...
          <div className="bank-account-name">
            <FormField
              fieldId="bankAccountName"
              fieldLabel={this.context.t('admin_payment_methods_account_name')}
              placeholder={this.context.t('admin_payment_methods_account_name')}
              isMandatoryField
              formControlName="bankAccount.accountName"
              typeField="custom_input"
            />
          </div>
          <div className="bank-account-number">
            <FormField
              ...
              fieldLabel={this.context.t('admin_payment_methods_account_number')}
              placeholder={this.context.t('admin_payment_methods_account_number')}
              isMandatoryField
              formControlName="bankAccount.accountNumber"
              typeField="custom_input"
            />
          </div>
          <div className="bank-account-office">
            <FormField
              fieldId="bankAccountOffice"
              fieldLabel={this.context.t('admin_payment_methods_account_office')}
              placeholder={this.context.t('admin_payment_methods_account_office')}
              isMandatoryField
              formControlName="bankAccount.accountOffice"
              typeField="custom_input"
            />
          </div>
        </div>
