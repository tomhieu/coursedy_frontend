            ...
            <ul className="dashboard-links">
              ...
              <li className={isActiveCourseTab ? activeDashboardItemClasses.join(' ') : dashboardItemClasses.join(' ')}>
                <div className="d-flex flex-column flex-auto">
                  <div className={isActiveCourseTab ? multipleDashboardItemClasses : multipleDashboardItemCollapsedClasses}
                       data-toggle="collapse" data-target={"#courseChildTab"} aria-expanded="true">
                    {
              ...
              <li className={isActiveTeacherTab ? activeDashboardItemClasses.join(' ') : dashboardItemClasses.join(' ')}>
                <div className="d-flex flex-column flex-auto">
                  <div className={isActiveTeacherTab ? multipleDashboardItemClasses : multipleDashboardItemCollapsedClasses}
                       data-toggle="collapse" data-target={"#teacherChildTab"} aria-expanded="true">
                    {
                  ...
                  <ul id="teacherChildTab" className={isActiveTeacherTab ? "collapse sub-dashboard-item show" : "sub-dashboard-item collapse"}
                      aria-labelledby="courseChildTab" data-parent="#accordion">
              ...
              <li className={isActiveStudentTab ? activeDashboardItemClasses.join(' ') : dashboardItemClasses.join(' ')}>
                <div className="d-flex flex-column flex-auto">
                  <div className={isActiveStudentTab ? multipleDashboardItemClasses : multipleDashboardItemCollapsedClasses}
                       data-toggle="collapse" data-target={"#studentChildTab"} aria-expanded="true">
                    {
                  ...
                  <ul id="studentChildTab" className={isActiveStudentTab ? "collapse sub-dashboard-item show" : "sub-dashboard-item collapse"}
                      aria-labelledby="courseChildTab" data-parent="#accordion">
                    <li className={activatedTab === 'admin_courses_list' ? styles.dashboardItem + ' ' + styles.active : styles.dashboardItem}
