  ...
  render() {
    ...
    return (
      <div id="course-detail-intro" className="course-detail-section">
            ...
            <ul className="listing-box-list">
              <li>
                <div className="row gap-10">
                  <div className="col-xs-8 col-sm-8"><i
                    className="fa fa-clock-o mr-5"></i> {this.context.t('period')}
                  </div>
                  <div
                    className="col-xs-4 col-sm-4 text-right font600">{course.period}</div>
                </div>
              </li>
              <li>
                <div className="row gap-10">
                  <div className="col-xs-6 col-sm-6"><i
                    className="fa fa-calendar mr-5"></i> {this.context.t('start_time')}
                  </div>
                  <div
                    className="col-xs-6 col-sm-6 text-right font600">{DateUtils.formatDate(course.start_date)}</div>
                </div>
              </li>
              <li>
                <div className="row gap-10">
                  <div className="col-xs-8 col-sm-8"><i
                    className="fa fa-pencil-square-o mr-5"></i> {this.context.t('course_lessons')}
                  </div>
                  <div
                    className="col-xs-4 col-sm-4 text-right font600"> {course_sections.length}</div>
                </div>
              </li>
              <li>
                <div className="row gap-10">
                  <div className="col-xs-8 col-sm-8"><i
                    className="fa fa-users mr-5"></i> {this.context.t('number_of_students')}
                  </div>
                  <div
                    className="col-xs-4 col-sm-4 text-right font600"> {course.number_of_students}</div>
                </div>
              </li>
            </ul>
          </div>
        ...
        <h5
          className="course-about-heading text-uppercase font700 mb-20">{this.context.t('course_about')}</h5>
