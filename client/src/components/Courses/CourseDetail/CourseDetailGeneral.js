  ...
  return (
    <table className="table table-responsive">
      ...
      <tbody>
        ...
        <tr>
          <td className="text-center"><i className="fa fa-facebook" /></td>
          <td className="text-center"><i className="fa fa-twitter" /></td>
          <td className="text-center"><i className="fa fa-google-plus" /></td>
          <td className="text-center"><i className="fa fa-linkedin" /></td>
        </tr>
      </tbody>
      <tfoot>
        <tr>
