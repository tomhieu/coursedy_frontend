          ...
          <div className="panel-body">
            <ul className="dashboard-links">
              ...
              >
                ...
                <a className='dashboard-item-name'>{this.context.t('my_profile')}</a>
              </li>
              <li
                className={activatedTab === 'enrolled_course_list' ? activeDashboardItemClasses.join(' ') : dashboardItemClasses.join(' ')}
              ...
              >
                ...
                <a className='dashboard-item-name'>{this.context.t('enrolled_courses')}</a>
              </li>
              <li
                className={activatedTab === 'enrolling_course_list' ? activeDashboardItemClasses.join(' ') : dashboardItemClasses.join(' ')}
              ...
              >
                ...
                <a className='dashboard-item-name'>{this.context.t('enrolling_courses')}</a>
              </li>
              <li
                className={activatedTab === 'following_course_list' ? activeDashboardItemClasses.join(' ') : dashboardItemClasses.join(' ')}
              ...
              >
                ...
                <a className='dashboard-item-name'>{this.context.t('followed_courses')}</a>
              </li>
            </ul>
          </div>
        </div>
