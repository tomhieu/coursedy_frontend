  ...
  render() {
    ...
    return (
      ...
      <svg width={width + "px"} height={height + "px"} viewBox="0 0 14 14">
        <defs>
          <polygon id="path-close" points="14 1.41 12.59 0 7 5.59 1.41 0 0 1.41 5.59 7 0 12.59 1.41 14 7 8.41 12.59 14 14 12.59 8.41 7"></polygon>
        </defs>
          ...
          <g id="Atoms-/-Icon/System/-Error" transform="translate(-5.000000, -5.000000)">
            <g id="Pallet/#3" transform="translate(5.000000, 5.000000)">
              <mask id="mask-2" fill="white">
                <use xlinkHref="#path-close"></use>
              </mask>
              <use id="Mask" fill-opacity="0.7" fill={fillColor} xlinkHref="#path-close"></use>
            </g>
          </g>
        </g>
      </svg>
