  ...
  render() {
    ...
    return (
      ...
      <svg width={width + "px"} height={height + "px"} viewBox="0 0 38 38" version="1.1">
        <defs>
          <polygon id="path-facebook" points="37.7857843 0.212025243 37.7857843 37.6309573 0.000111764706 37.6309573 0.000111764706 0.212025243"></polygon>
        </defs>
