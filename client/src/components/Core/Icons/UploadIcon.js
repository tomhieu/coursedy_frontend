...
class UploadIcon extends Component {
  render() {
    const { width = 40, height = 40 } = this.props;
    return (

      <svg viewBox="0 0 486.3 486.3" width={width} height={height} className="upload-image">
...
export default cssModules(UploadIcon, styles);
