  ...
  render() {
    ...
    return (
      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 26 26" style={{'width': width + 'px', 'height': height + 'px', 'fill': fillColor}} xmlSpace="preserve">
        <g>
          <path style={{fill: fillColor}} d="M20.25,19.547V23c0,0.552-0.449,1-1,1h-14c-0.551,0-1-0.448-1-1V3c0-0.552,0.449-1,1-1h14
          ...
          <g>
            <path style={{fill: fillColor}} d="M16.25,19.5c0,0-1,0.281-1-1c0-0.29,0-1.257,0-2.5h-6c-0.552,0-1-0.449-1-1v-4c0-0.551,0.448-1,1-1
