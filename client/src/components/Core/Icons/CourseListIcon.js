  ...
  render() {
    ...
    return (
      <svg width={width + 'px'} height={height + 'px'} viewBox="0 0 22 18" version="1.1">
        <defs>
          <path d="M5,13.18 L5,17.18 L12,21 L19,17.18 L19,13.18 L12,17 L5,13.18 L5,13.18 Z M12,3 L1,9 L12,15 L21,10.09 L21,17 L23,17 L23,9 L12,3 L12,3 Z" id="path-course-list"></path>
        </defs>
        <g id="🛠--Symbols-&amp;-Components" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="Atoms-/-Icon/System/-School" transform="translate(-1.000000, -3.000000)">
            ...
            <use id="Mask" fillOpacity="1" fill={fillColor} xlinkHref="#path-course-list"></use>
          </g>
        </g>
      </svg>
    )
