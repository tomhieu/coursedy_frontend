      ...
      <div className={classNames}>
        ...
        <a className={`${styles.deleteChipIcon} delete-icon-chip`} onClick={onRequestDelete} role="button">
          <svg id="cx-icon-x_16x16" viewBox="0 0 16 16" width="100%" height="100%">
            <path d="M9.75 8L14 3.82a.53.53 0 0 0 0-.75l-1-.95a.54.54 0 0 0-.75 0L8 6.26 3.79 2.08a.54.54 0 0 0-.75 0l-.95.94a.53.53 0 0 0 0 .75L6.25 8 2 12.18a.53.53 0 0 0 0 .75l1 .95a.54.54 0 0 0 .75 0L8 9.74l4.21 4.19a.54.54 0 0 0 .75 0l.95-.94a.53.53 0 0 0 0-.75z" fillRule="evenodd" />
          </svg>
        </a>
      </div>
    );
