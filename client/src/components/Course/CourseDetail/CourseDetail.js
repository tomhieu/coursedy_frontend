    ...
    return (
      <div className="course-detail">
              ...
              <div className="panel-body">
                ...
                <div className="col-xs-12 text-center">
                  <ul className="list-unstyled list-inline">
                    ...
                    <li><i className="fa fa-2x fa-google-plus"></i></li>
                    <li><i className="fa fa-2x fa-linkedin"></i></li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className="col-xs-12">
          ...
          <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam atque architecto eius provident, soluta, obcaecati consequuntur excepturi aliquam dolorum doloremque tempora reprehenderit odio distinctio repellendus impedit asperiores quasi, voluptates inventore.</p>
          ...
          <div className="panel-group">
            {
              ...
              <div className="panel panel-primary">
                <div className="panel-heading">
                  ...
                  Chương {index+1} - Introduction to Photoshop CS6 Extremely</a>
                  </h4>
                </div>
                  ...
                  <div className="col-xs-12 col-sm-12 col-md-10">
                    ...
                    <p>
                      <ul className="list-inline">
                        <li><i className="fa fa-share"></i> Share: </li>
