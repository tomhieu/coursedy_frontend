...
export const dummyTeacherDetail = ({id}) => ({
  ...
  courses: {
    ...
    data: [
      {id: 1, title: "Foundations of Enterprise Development for Windows", description: "Create Code That Screams with C++! Hours of Video Lecture, Lab Exercises and Dozens of Code Samples for You To Use! Dave Pither-Patterson", cover_image: "", rating: 5, period: 15, start_date: "2018-04-16T00:00:00.000Z", tuition_fee: 3750000, category: {id: 1, name: "Programming"}, user: {id: 1, name: "Mark Lassoff", avatar: "http://crenoveative.com/envato/edutute/images/testimonial/01.jpg"},},
      {id: 2, title: "Food Photography: Shooting at Restaurants", description: "She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel.", cover_image: "http://crenoveative.com/envato/edutute/images/course-item/02.jpg", rating: 5, period: 15, start_date: "2018-04-16T00:00:00.000Z", tuition_fee: 4750000, category: {id: 2, name: "Photography"}, user: {id: 2, name: "Nicholas Mavrakis", avatar: "http://crenoveative.com/envato/edutute/images/testimonial/01.jpg"},},
      {id: 3, title: "Food Photography: Shooting at Restaurants", description: "She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel.", cover_image: "http://crenoveative.com/envato/edutute/images/course-item/02.jpg", rating: 5, period: 15, start_date: "2018-04-16T00:00:00.000Z", tuition_fee: 4750000, category: {id: 2, name: "Photography"}, user: {id: 3, name: "Ange Ermolova", avatar: "http://crenoveative.com/envato/edutute/images/testimonial/03.jpg"},},
    ]
  }
})
