...
export default {
  ...
  sample_course_title: 'ví dụ: Luyện thi TOEIC cấp tốc',
  ...
  sample_number_of_lessons: 'ví dụ: 10',
  period_mandatory: 'Vui lòng nhập thời gian học',
  number_of_students: 'Số học viên',
  sample_number_of_students: 'ví dụ: 5',
  minimum_number_of_students: 'Số học viên phải từ 1 trở lên.',
  num_student_mandatory: 'Vui lòng nhập số học viên',
  tuition_fee: 'Học phí khoá học',
  sample_tuition_fee: 'ví dụ: 1000000',
  ...
  period_per_lesson: 'Thời gian một bài học',
  period_per_lesson_mandatory: 'Vui lòng thời gian một bài học',
  ...
  teaching_period_per_day: 'ví dụ: thứ 2, thứ 3, thứ 4,...',
  teaching_start_time_per_week_madatory: 'Vui lòng chọn thời gian bắt đầu bài học',
  teaching_end_time_per_week_madatory: 'Vui lòng chọn thời gian kết thúc bài học',
  ...
  sample_course_category: 'ví dụ: Ngoại ngữ',
  course_level: 'Cấp độ',
  category: 'Lớp học',
  ...
  lesson_period_short: 'Thời lượng (phút)',
  ...
  */
  ...
  sample_course_specialize: 'ví dụ: Tiếng anh giao tiếp',
  level: 'Cấp độ', /*
     * Filter Course Page
     */
  filter: 'Tìm kiếm',
  ...
  not_found_suggestion: 'Không tìm thấy kết quả', /*
    ...
    */
  pending_course_list: 'Khoá học đang chờ phê duyệt',
  approved_course_list: 'Khoá học đã được phê duyệt',
  rejected_course_list: 'Khoá học chưa hợp lệ',
  teaching_course_list: 'Khoá học đang dạy',
  finished_course_list: 'Khoá học hoàn thành',

  pending_course_list_title: 'Khoá học đang chờ phê duyệt',
  approved_course_list_title: 'Khoá học đã được phê duyệt',
  rejected_course_list_title: 'Khoá học chưa hợp lệ',
  teaching_course_list_title: 'Khoá học đang dạy',
  finished_course_list_title: 'Khoá học hoàn thành',
  ...
  header_available_lesson: 'Số bài học hiện có: {numberLesson}',
  header_number_completed_lessons: 'Hoàn thành: {numberLesson} bài học',
  header_number_completed_single_lesson: 'Hoàn thành: 1 bài học',
  header_no_completed_lesson: 'Chưa hoàn thành bài học nào',
  ...
  search_empty_result_header: 'Hãy thử tìm kiếm với yêu cầu khác hoặc',
  search_empty_result_reset: 'thử lại từ đầu',
  search_empty_result: 'Không tìm thấy {type} nào phù hợp với yêu cầu hiện tại của bạn.',
  course_type: 'khoá học',
  ...
  course_lessons: 'Bài học hiện có',
  ...
  sample_start_date: 'ví dụ: 31/12/2018',
  ...
  cancel_started_course_warning_message: 'Khoá học đang dạy và chưa kết thúc, nêu huỷ bây giờ bạn sẽ không thể tiếp tục khoá học và không nhận được tài liệu mới.',
  cancel_started_course_feedback: 'Nếu bạn không hài lòng với chất lượng khoá học có thể viết nhận xét {course_details} hoặc gửi phản hồi với {coursedy}, chúng tôi sẽ cố gắng nhất có thể để khoá học đám ứng đủ yêu cầu của bạn.',
  cancel_course_details: 'về khoá học',
  bill_course_fee_popup_title: 'Thanh toán khoá học',
  enrolled_course_details: 'Chi tiết khoá học',
  enrolled_course_billing_details: 'Chi tiết thanh toán khoá học',
  ...
  no_pending_course_message: 'Hiện tại bạn chưa tạo khoá học nào.',
  no_approved_course_message: 'Hiện tại bạn chưa tạo khoá học nào.',
  no_rejected_course_message: 'Hiện tại bạn chưa tạo khoá học nào.',
  no_teaching_course_message: 'Hiện tại bạn chưa dạy khoá học nào.',
  ...
  lesson_rating_title: 'Đánh giá bài học',
  ...
  enroll_course_term_5: 'Một số bài học có thể được bổ sung hoặc sửa đổi bởi giáo viên',
  enroll_course_sub_term_5: 'Coursedy sẽ thông báo khi có sự thay đổi về nội dung các bài học của khoá học từ giáo viên.',
