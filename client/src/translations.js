...
export const translations = {
  vn: {
    ...
    create_course_sucessfully_message: 'Khoá Học {title} vừa được tạo thành công. Khoá học hiện đang ở trang thái "{notReadyStatus}".',
    ...
    */
    ...
    order_by_price_desc: 'Học phí giảm dần',
    order_by_price_asc: 'Học phí tăng dần',
    ...
    */
    ...
    homepage_search_introduce_explore: 'Đa dạng khoá học',
    ...
    account_pending_warning_message: 'Tài khoản của bạn hiện tại đang ở trạng thái {pending_status}. Vui lòng điền đầy đử thông tin tài khoản. Một khi điền đầy đử thông tin yêu cầu, chúng tôi sẽ kiêm tra và xác nhận thông tin trong vòng 24h',
  ...
  en: {
    ...
    first_name_required: 'Please fill out first name',
    ...
    create_course_sucessfully_message: 'Course {title} has been created successfully. Now the course is in status "{notReadyStatus}"',
